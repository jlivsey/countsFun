...
n=5000
df21 = PoisAR1_GL(CountDist, MargParm, ARParm, n, nsim, no_cores)
save(df21, file = sprintf("Pois%sAR%s_GL_N%s_NS%s_Phi%s.RData", MargParm, 1, n, nsim, PhiSign))
...
n=5000
df22 = PoisAR1_GL(CountDist, MargParm, ARParm, n, nsim, no_cores)
save(df22, file = sprintf("Pois%sAR%s_GL_N%s_NS%s_Phi%s.RData", MargParm, 1, n, nsim, PhiSign))
