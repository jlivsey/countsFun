...
test_that("The likelihood function ParticleFilter_Res_ARMA works for a 'misspecified' model", {
...
#1128.04720028058
expect_equal(ParticleFilter_Res_ARMA(theta,mod), 1127.91740341, tolerance = 10^(-5))
