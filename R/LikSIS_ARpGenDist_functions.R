...
# compute predictive distribution
PDvaluesARp = function(theta, data, Regressor, ARMAorder, ParticleNumber,CountDist){
...
FitMultiplePF_Res = function(theta, data, Regressor, ARMAorder, ParticleNumber, CountDist, epsilon, LB, UB, OptMethod){
  #====================================================================================#
